            ...
            <main>
                ...
                <div class={pageContent}>
                    <section class={[container]}>
                        ...
                        <p>
                            このサイトはyamaimo (
                            <Link to={link.twitterAdmin.url} external icon="twitter">
                        ...
                        <p>
                            サイト・クラウドで稼働しているプログラムは、GitHubで公開しています。MITライセンスに基づきご自由にお使いいただけます。
                        </p>
                        <p>
                            <Link to={link.github} external icon="github-circle">
                                yarnaimo/reinainfo
                            </Link>
                        </p>
                    </section>
